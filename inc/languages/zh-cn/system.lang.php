...
/*Language Format:
Add a new file(.lang.php) with your module name at /inc/languages/
...
$LANG['copyright_of']='2012 后台管理系统';
 
//后台导航
$LANG['home_management']='幻灯管理';
$LANG['classification_management']='分类管理';
$LANG['category']='栏目';


$LANG['customer_management']='客户管理';
$LANG['customer']='客户';

$LANG['article']='文章';

$LANG['hello']='你好';
$LANG['website_home']='网站首页';


$LANG['common_operations']='常用操作';
$LANG['slide_picture']='幻灯图片';
$LANG['all']='所有';
$LANG['list']='列表';
$LANG['name']='名称';
$LANG['create_top_category']='创建一级分类';
$LANG['class']='分类';
$LANG['addtime']='添加时间';

$LANG['audit']='审核';
$LANG['images']='图片';
$LANG['add_edit_picture_information']='新增/编辑图片信息';
$LANG['title_image']='图片标题';
$LANG['hide']='隐藏';
$LANG['show']='显示';
...
$LANG['color_category']='颜色';		//分类下的颜色盒子
$LANG['blue_category']='蓝色';
$LANG['green_category']='绿色';
$LANG['orange_category']='橙色';
$LANG['sina_category']='微博';
$LANG['purple_category']='紫色';
...
$LANG['slide_picture_index']='首页幻灯图片';

$LANG['slide_picture_index_sub']='首页业绩幻灯图片';

$LANG['slide_picture_sub']='子页幻灯图片';
$LANG['admin_manage']='管理员';
$LANG['admin_name']='管理员用户名';
$LANG['admin']='管理员';
$LANG['admin_management']='管理员管理';
$LANG['msg_manage']='查看留言';

$LANG['upload_hot']='下载次数'; 
$LANG['html']='静态';
$LANG['updatetime']='更新时间';
$LANG['article_management']='咨询管理';
$LANG['article_classification']='咨询分类管理';

$LANG['product_management']='产品管理';
$LANG['product_classification']='产品分类管理';

$LANG['upload_management']='下载管理';
$LANG['upload_classification']='下载分类管理';
$LANG['product']='产品';
$LANG['upload']='下载';
$LANG['recommend']='推荐';
