...
class content_tag {
	...
	public function __construct() {
		$this->db = inc_base::load_model('content_model');
		$this->position = inc_base::load_model('position_data_model');
	}
	/**
	 * 初始化模型
	 * @param $catid
	...
	public function hits($data) {
		...
		$this->hits_db = inc_base::load_model('hits_model');
		$sql = $desc = $ids = '';
	...
	public function pc_tag() {
		...
		$sites = inc_base::load_app_class('sites','admin');
