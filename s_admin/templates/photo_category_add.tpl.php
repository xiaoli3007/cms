...
<div class="subnav">
    ...
    <a href="photo_category.php" class="add fb"><em>分类列表</em></a>　
    </div>
</div>
...
<form name="myform" id="myform" action="photo_category.php?contenttype=<?php echo $_GET['contenttype'];?>" method="post" onSubmit="return submit_content();">
