...
<a href="category.php?contenttype=add" class="on"><em>添加分类</em></a>

<a href="category.php?contenttype=html_index" class="on"><em>更新首页</em></a>

<a href="category.php?contenttype=html_all_cat" class="on"><em>更新全部列表页</em></a>
<a href="category.php?contenttype=html_all_show" class="on"><em>更新全部内容页</em></a>
...
<tbody> 
    ...
    <td align='center'><a href="category.php?contenttype=edit&id=<?php echo $r['catid'];?>">编辑</a></td>
	</tr>-->
     <?php }
	}
	?>
