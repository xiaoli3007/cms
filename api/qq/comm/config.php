...
$_SESSION["appid"]    = 100361241; 

//申请到的appkey
//$_SESSION["appkey"]   = "yourappkey"; 
$_SESSION["appkey"]   = "86f345afa50c3cd156d6e766ba605de0"; 

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
$_SESSION["callback"] = "http://www.saibaohui.com/api/qq/oauth/qq_callback.php"; 
//$_SESSION["callback"] = "http://www.saibaohui.com/reg.php?step=api_reg&api_type=qq"; 
